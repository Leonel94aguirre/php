...
if ($_POST) {
    ...
    //Amacenar el json en archivo.txt
    file_put_contents("archivo.txt", $strJson);
} 
            ...
            <div class="col-6">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <input type="text" name="txtTelefono" id="txTelefono" class="form-control" value="<?php echo isset($aClientes[$id]["telefono"]) ? $aClientes[$id]["telefono"] : ""; ?>">
                    </div>
                    <div>
